...
export class AdminComponent implements OnInit {
    ...
    getGuests() {
        ...
        this.http.get<Guest[]>(`${environment.apiUrl}/invitado/all`).subscribe({
            next: guests => {
                ...
                this.totalAttendees = guests.filter(g => g.confirmed).reduce((sum, g) => sum + (g.attendees || 0), 0);
    ...
    addGuest() {
        ...
        this.http.post<any>(`${environment.apiUrl}/invitado`, this.form.value).subscribe({
            next: res => {
